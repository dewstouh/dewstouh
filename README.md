...
- <strong>Commit</strong> to <a href="https://github.com/Quickfra/quickfra">Quickfra/quickfra</a>: chore(scripts/lib/coolify): add TODO to replace SQL hack with API call • about 11 hours ago
- <strong>Commit</strong> to <a href="https://github.com/Quickfra/quickfra">Quickfra/quickfra</a>: chore(docker/snappymail): remove TZ environment variable from compose file • about 11 hours ago
- <strong>Commit</strong> to <a href="https://github.com/Quickfra/quickfra">Quickfra/quickfra</a>: docs(README): mark day 3 as completed in roadmap with video example • about 11 hours ago
- <strong>Commit</strong> to <a href="https://github.com/Quickfra/quickfra">Quickfra/quickfra</a>: refactor(scripts/lib/coolify): set FQDN to 'coolify.$domain' subdomain in set_coolify_domain • about 16 hours ago
- <strong>Commit</strong> to <a href="https://github.com/Quickfra/quickfra">Quickfra/quickfra</a>: fix(scripts/lib/coolify): invalid input syntax for type bigint: "null", function get_main_coolify_server_id was returning .server_id instead of .settings.server_id (outdated Coolify docs) • about 16 hours ago
...
*Last updated: 07 July 2025 04:23*   